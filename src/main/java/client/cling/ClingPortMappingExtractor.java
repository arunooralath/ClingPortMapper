...
import client.cling.action.GetPortMappingEntryAction;
...
class ClingPortMappingExtractor {
	...
	public Collection<PortMapping> getPortMappings() throws RouterException {
		 ...
		 * that gets the number of available port mappings
		 * (getNatMappingsCount()), but it seems, that this method just tries to
		 * get all port mappings and checks, if an error is returned.
		 *
	 ...
	 * <li>Other errors, e.g. "The reference to entity "T
	 * " must end with the ';' delimiter" or "Content is not allowed in prolog":
	 * 899 (e.g. ActionTec MI424-WR, Thomson TWG850-4U)</li>
	 * </ul>
	 * See bug reports
	 * <ul>
	 * <li><a href=
	 ...
	 * <li><a href="http://www.sbbi.net/forum/viewtopic.php?p=394">http://www.
	 * sbbi .net/forum/viewtopic.php?p=394</a></li>
	 * <li><a href=
